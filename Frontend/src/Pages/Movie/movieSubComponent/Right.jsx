            ...
            {movieDetails && (
                <>
                    <button
                        ...
                        className={`${watched ? "bg-(--accent) hover:bg-(--accent-hover) text-(--text) active:bg-(--accent)" : "bg-(--surface) hover:bg-(--surface-hover) active:bg-(--surface) text-(--text)"} flex items-center gap-2  p-2 rounded-[10px] border border-white/20 `}
                    >
                    ...
                    {!watched && (
                        <button
                            ...
                            className={` ${watchlist ? "bg-(--accent) hover:bg-(--accent-hover) text-(--text) active:bg-(--accent)" : "bg-(--surface) hover:bg-(--surface-hover) active:bg-(--surface) text-(--text) "} flex items-center gap-2 p-2 rounded-[10px] border border-white/20`}
                        >
                            {/* <CiHeart /> */}
