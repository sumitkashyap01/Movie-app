                ...
                <>
                    <div className="z-99 sm:mt-10  md:mt-0 flex justify-center">
                        <div className="flex flex-col gap-5 md:w-[85%] md:p-5 p-2 rounded-2xl bg-(--surface)">
                            ...
                            <hr/>
                            <div className="grid gap-3 lg:gap-5 lg:grid-cols-6 md:grid-cols-4 grid-cols-3">
                                {credits?.cast?.slice(0, 15).map((item, index) => (
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <div className="flex flex-col items-center font-bold">
                                            <p className="text-sm lg:text-base text-(--text-secondary)">{item.character}</p>
                                            <p className="text-(--text-muted) font-poppins font-extrabold lg:text-sm text-[10px]">
                                                {item.name}
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div className="flex flex-col gap-3 lg:gap-5 items-center">
                        <h1 className="lg:text-5xl md:text-4xl text-3xl font-poopins font-bold text-(--accent)">
                            You Might Also Like
                        </h1>
                        <div
                            className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 lg:w-[85%] w-[95%] gap-3 lg:gap-5">
